...
const home_4_1_2_3_Formation: TeamFormation = {
  ...
  SUB3: POSITION.Substitute.home.SUB3,
  SUB4: POSITION.Substitute.home.SUB4,
  SUB5: POSITION.Substitute.home.SUB5,
}
...
const home_4_1_2_1_2_Formation: TeamFormation = {
  ATG: POSITION.ATG.home,
  ATD: POSITION.ATD.home,
  MOC: POSITION.MOC.home,
  MCG: POSITION.MCG.home,
  MCD: POSITION.MCD.home,
  MD: POSITION.MD.home,
...
const away_4_1_2_1_2_Formation: TeamFormation = {
  ATG: POSITION.ATG.away,
  ATD: POSITION.ATD.away,
  MOC: POSITION.MOC.away,
  MCG: POSITION.MCG.away,
...
const away_4_1_3_2_Formation: TeamFormation = {
  ATG: POSITION.ATG.away,
  ATD: POSITION.ATD.away,
  MOC: POSITION.MOC.away,
  MLG: POSITION.MLG.away,
