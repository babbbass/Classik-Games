          ...
          {MATCHES.map((match) => (
            <li key={match.id} className='my-3'>
              <Link href={`/match/${match.id}`}>
                <Card className='text-slate-700 font-bold  hover:text-slate-800 transition-all duration-200 py-4 ease-in-out hover:scale-105 bg-gradient-to-b from-yellow-200 to-yellow-500 flex items-center md:w-1/2 mx-auto rounded-xl shadow-xl'>
