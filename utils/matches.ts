export const MATCHES = [
  {
    ...
    players: {
      home: [
        ...
        { name: "Joao Neves", position: "MG" },
        { name: "Vitinha", position: "MC" },
        { name: "Fabian Ruiz", position: "MD" },
  ...
  {
    id: 3,
    homeTeam: { name: "FC Barcelone", formation: "4-3-3", color: "#21304D" },
    awayTeam: { name: "Real Madrid", formation: "4-4-2", color: "#43A1D5" },
    competition: "La Liga",
    season: "2009-10",
    description:
